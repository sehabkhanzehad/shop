...
class SettingController extends Controller
{
    ...
    public function courier_index() {
        if(!auth()->user()->can('courier_index')){
    ...
    public function updateCourierSetting(Request $request) {
        if(!auth()->user()->can('update-courier-setting')){
            abort(403, 'Unauthorized action.');
        } 
    ...
    public function updateTawkChat(Request $request){
        if(!auth()->user()->can('update-courier-updateTawkChat')){
            abort(403, 'Unauthorized action.');
        } 
        $rules = [
            'allow' => 'required',
    ...
    public function updateSocialLogin(Request $request){
            ...
            if(!auth()->user()->can('update-courier-updateSocialLogin')){
            abort(403, 'Unauthorized action.');
        } 
        $rules = [
    ...
    public function updateFacebookPixel(Request $request){
        if(!auth()->user()->can('update-updateFacebookPixel')){
            abort(403, 'Unauthorized action.');
        } 
        dd($request->all());
        $rules = [
