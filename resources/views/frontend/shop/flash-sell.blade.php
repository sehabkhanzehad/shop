...
<div class="container-fluid main-section" style="padding-bottom: 30px;
    padding-top: 11px;">
                ...
                <div class="product_thumb bg-white prd_img" style="">
                    <a class="primary_img " href="{{ route('front.product.show', [ $product->product->id ] ) }}"><img src="{{ asset('uploads/custom-images2/'.$product->product->thumb_image) }}" class="primcusImg" alt="" style="width: 100%;"></a>
                    <a style="display: none;" class="secondary_img" href="{{ route('front.product.show', [ $product->product->id ] ) }}"><img src="{{ asset('uploads/custom-images2/'.$product->product->thumb_image) }}" class="seccusImg" alt="" style=""></a>
    ...
    background-color: #fff;">
                    <h4 class="ps-1" style="height: 35px;">
                        <a href="{{ route('front.product.show', [ $product->product->id ] ) }}" class="font-14" style="font-size:14px;color: #000;
    font-weight: 700;"> {{ \Illuminate\Support\Str::limit($product->product->name, 40)}}</a>
                    </h4>
