                    ...
                    <div class="row flex-lg-row-reverse">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div
                                                            class="d-flex justify-content-between align-item-conter al_btn">
                                                            <p class="login_text" style="font-size: 14px;">
                                                                {{ BanglaText('login_account') }} <a
                                                                    style="font-size: 11px;background: #0f134f;color: #ffffff;"
                                                                    class="btn" href="{{ url('login-user') }}"
                                                                    class="text-muted text-decoration-none icon-signin">Login</a>
                                                            </p>
                                                    ...
                                                    <td>
                                                        <div id="coupon-toggle"
                                                            style="font-size: 12px;background: #0f134f;color: #ffffff;"
                                                            class="btn">{{ BanglaText('coupon_apply') }}</div>
                                                            ...
                                                            <form action="{{ route('front.cart.apply-coupon') }}"
                                                                ...
                                                                <div class="col-lg-12 col-12 mb-2 mt-2 form-floating">
                                                                    ...
                                                                    <input type="hidden" name="shipping_id"
                                                                        id="shipping_id" value="">
                                                                    <label for="code" class="ps-4">Apply
                                                                        Coupon</label>
                                                                </div>
                                                                <div class="">
                                                                    <button type="submit" class="btn bg-blue text-light"
                                                                        style="font-family: 'Kalpurush', sans-serif;">Apply
                        ...
                        <div id="data_info" class="col-lg-6">
                           ...
                           ?>
                                        ...
                                        @endif
                                        <button type="submit" class="btn bg-blue text-light"
                                            style="font-family: 'Kalpurush', sans-serif;width: 100%;height: 50px;font-size: 20px;background: #0f134f !important;">{{ BanglaText('confirm_order') }}
