...
<html lang="en">
   ...
   <body>
    ...
    <!--     </div>-->
         ...
         <div class="tops_section" style="background: #ffffff;">
             <div class="elementor-widget-wrap elementor-element-populated">
                  <div class="element-widget overview" style="margin-top: 0px;color: black;">
                      <div class="top_section" style="
                        ...
                        padding: 15px;">
                          ...
                          <img src="{{ asset('landing_pages/'.$ln_pg->landing_bg) }}" style="width: 100%;height: auto;box-shadow: 0px 0px 16px 0px grey;
    border-radius: 10px;" alt="img">
                          
                          <h1 class="top-heading-title" style="color: #000000;margin-top: 45px;text-align: center;padding-bottom: 45px;font-weight: 900;">
                                {{ $ln_pg->title1 }}
                          </h1>
         ...
         <div class="down-div">
            <div class="container">
               ...
               <div class="elementor-widget-wrap elementor-element-populated">
                      <div class="top_section" style="
                        ...
                        padding: 15px;margin-top: 20px;">
                           <p style="margin-bottom:0px;font-family: 'Hind Siliguri', sans-serif !important;text-align: center;">{{ $ln_pg->call_text }}</p>
               ...
               <div class="element-widget feature-list" style="background: #ffffff;text-align: left;">
                    <div class="row">
                        <div class="col-md-12 left_sidebar_section">
                            <div class="left_side_text" style="border: 9px solid #ff730b;
                                text-align: center;
                                padding: 10px;
                                border-radius: 10px;
                                font-size: 25px;
                              ...
                              <div class="address_section col-md-6" style="width: 50%;float: left;">
                                 <div class="form-address">
                                    <div class="address-col">
                                       <h3 style="font-family: 'Hind Siliguri', sans-serif !important;">Billing Address</h3>
                                       <div class="billing-fields">
                                          ...
                                          <div class="form-group">
                                                    ...
                                                    @php ($free_shipping = App\Models\Shipping::where('shipping_rule', 'Free')->first());
                                                        <option value="{{ $free_shipping->id }}" selected id="charge" data-charge="{{ $free_shipping->shipping_fee }}">{{ $free_shipping->shipping_rule}} - {{ $free_shipping->shipping_fee }}</option>
                                                    @endif
                                                    @endif
                                                    </select>
                                                    </div>
                                          ...
                                          @if(isset($ln_pg->product))
                                          <input type="hidden" id="product_type" value="{{ $ln_pg->product->type }}">
                                          @endif
                                          @if(isset($ln_pg->product))
                                          @if($ln_pg->product->type != 'variable')       
                                              @if($ln_pg->product->offer_price != 0)
                                              <!--<input type="text" id="price_val" value="0">-->
                                              <input type="hidden" id="product_price" name="price" value="{{ $ln_pg->product->offer_price }}">
                                              @else
                                          <!--<input type="text" id="price_val" value="0">-->
                                          ...
                                          <input type="hidden" id="size" name="variation_size">
                                          <input type="hidden" id="color" name="variation_color">
                                          @endif
                                          @endif
                    ...
                    outline: 2px solid red;
                              ...
                              <div class="col-md-6">
                                 <div class="order-col" style="width: 100%;">
                                    <h3 style="font-family: 'Hind Siliguri', sans-serif !important;">Your Order</h3>
                                       ...
                                       <table class="shop_table review-order-table">
                                          ...
                                          <tbody>
                                                ...
                                                <td class="product-name">
                                                   <div class="product-image">
                                                      <div class="product-thumbnail">
                                                          @if(isset($ln_pg->product))
                                                          <img width="100%" src="{{ asset($ln_pg->product->thumb_image) }}" class="" alt="" >
                                                          @endif
                                                      </div>
                                                      @if(isset($ln_pg->product))
                                             ...
                                             <tr>
                                                ...
                                                <td style="width: 45%;">
                                                    ...
                                                    @foreach($ln_pg->product->variations as $v)
                                                        @if($v->size->id == 3)
                                                        @else
                                                        <div class="size" data-value="{{ $v->price }}" data-size="{{ $v->size->title }}" data-color="{{ isset($v->color->name) ? $v->color->name : ''  }}" data-dis-value="{{ $v->after_discount_price }}" value="{{$v->id}}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="colors" id="colors">
                                                        @if(isset($ln_pg->product))
                                                          ...
                                                          <div class="color" style="" data-proid="{{ $v->product_id }}" data-colorid="{{ $v->color_id }}" data-varcolor="{{ $v->color->name}}"
                                                             value="{{$v->id}}" data-variationColorId="{{ $v->color_id }}">
                                                            
                                                             <img src="{{ asset($v->var_images) }}" width="100%" height="100%" /> 
                                             ...
                                             <tr>
                                                <td>
                                                   <span style="font-family: 'Hind Siliguri', sans-serif !important;">Select Quantity: </span>
                                                </td>
                                                <td style="width: 45%;">
                                          ...
                                          <tfoot>
                                             <tr class="cart-subtotal">
                                                <th style="font-family: 'Hind Siliguri', sans-serif !important;">Subtotal</th>
                                             ...
                                             <tr class="shipping-totals shipping">
                                                <th style="font-family: 'Hind Siliguri', sans-serif !important;">Shipping</th>
                                                <td>
                                             ...
                                             <tr class="order-total">
                                                <th style="font-family: 'Hind Siliguri', sans-serif !important;">Total</th>
                                       ...
                                       <div id="payment" class="checkout-payment">
                                          <ul class="payment_methods payment_methods methods">
                                             <li class="payment_method payment_method_cod">
                                                <label for="payment_method_cod" style="font-family: 'Hind Siliguri', sans-serif !important;">
                                                Cash on delivery 	</label>
                                                <div class="payment_box payment_method_cod">
                                                   <p style="font-family: 'Hind Siliguri', sans-serif !important;">Pay with cash on delivery.</p>
                                                </div>
                                             </li>
                                          </ul>
                                          <p style="color: #ff730b;font-family: 'Hind Siliguri', sans-serif !important;">
                                             {{ BanglaText('order_ensure') }}
                                          </p>
                                          <div class="form-row place-order">
                                             <button type="submit" style="font-family: 'Hind Siliguri', sans-serif !important;" class="button" name="" id="">
                                                 {{ BanglaText('order') }}
                                                 </button>
                                          </div>
                                       </div>
