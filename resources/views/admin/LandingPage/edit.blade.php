                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="call_text" value="{{ $item->call_text }}"
                                                    class="form-control" placeholder="Title">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="right_side_title"
                                                    value="{{ $item->right_side_title }}" class="form-control"
                                                    placeholder="Title">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="top_heading_text"
                                                    value="{{ $item->top_heading_text }}" class="form-control"
                                                    placeholder="Title">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="img-box">
                                                <img src="{{ asset('landing_pages/' . $item->right_product_image) }}"
                                                    width="50">
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                <label class="form-label">Slider Top Text</label>
                                                <input type="text" name="feature" value="{{ $item->feature }}"
                                                    class="form-control" placeholder="Title">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="review_top_text"
                                                    value="{{ $item->review_top_text }}" class="form-control"
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            <div class="d-flex">
                                                @foreach ($review_images as $key => $review_image)
                                                    <div class="img-box">
                                                        <a href="{{ route('admin.delete_review', [$review_image->id]) }}"
                                                            class=""
                                                            onclick="return confirm(' you want to delete?');">&times;</a>
                                            ...
                                            <input type="file" name="review_product_image[]" class="form-control"
                                                multiple>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="new_price" value="{{ $item->new_price }}"
                                                    class="form-control" placeholder="Title">
                                            </div>
                                        </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                @if ($single_product != null)
                                                                    <img src="{{ asset('public/uploads/custom-images/' . $single_product->thumb_image) }}"
                                                                        height="50" width="50" />
                                                                @else
                                                                @endif
                                                            </td>
