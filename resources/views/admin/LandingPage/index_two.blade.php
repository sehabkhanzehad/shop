        ...
        <section class="section">
          ...
          <div class="col-xl-4" style="margin-bottom: 20px;padding: 0px;">
                        <div class="text-xl-end mt-xl-0 mt-2">
                            <a href="{{ route('admin.landing.create_two')}}" class="btn btn-primary"><i class="fas fa-plus"></i> {{__('admin.Add New')}}</a>       
                        </div>
                    </div>
          <div class="card">
                    <div class="card-body">
                     ...
                     <table class="table table-striped" id="">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('user.landing_index_two', $item->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                </td>
                              
                                <td>
                                    
                                    <a href="{{route('admin.landing_edit_two', $item->id)}}" class="btn btn-success btn-sm"><i class="fa fa-edit" aria-hidden="true"></i></a>
