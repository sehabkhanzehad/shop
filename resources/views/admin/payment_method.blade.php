                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-3">
                                    <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                        ...
                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="bkash-tab" data-toggle="tab" href="#bkashTab" role="tab" aria-controls="bkashTab" aria-selected="true">Bkash</a>
                                        </li>
...
<div class="tab-pane fade" id="bkashTab" role="tabpanel" aria-labelledby="bkash-tab">
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-bkash') }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="form-group">
                                                                <label for="">Bkash Status</label>
                                                                <div>
                                                                    @if ($bkash->status == 1)
                                                                        <input id="status_toggle" type="checkbox" checked data-toggle="toggle" data-on="{{__('admin.Enable')}}" data-off="{{__('admin.Disable')}}" data-onstyle="success" data-offstyle="danger" name="status">
                                                                        @else
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Account Mode')}}</label>
                                                                <select name="account_mode" id="bkash_account_mode" class="form-control">
                                                                    <option @selected($bkash->mode == 1) value="1">{{__('admin.Live')}}</option>
                                                                    <option @selected($bkash->mode == 0) value="0">{{__('admin.Sandbox')}}</option>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" readonly class="form-control" name="base_url" value="{{ $bkash->base_url }}">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">Username</label>
                                                                <input type="text" class="form-control" name="username" value="{{ $bkash->username }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">Password</label>
                                                                <input type="text" class="form-control" name="password" value="{{ $bkash->password }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">App Key</label>
                                                                <input type="text" class="form-control" name="app_key" value="{{ $bkash->app_key }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">App Secret</label>
                                                                <input type="text" class="form-control" name="app_secret" value="{{ $bkash->app_secret }}">
                                                            </div>
