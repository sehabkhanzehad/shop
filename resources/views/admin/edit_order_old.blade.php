                                    ...
                                    @foreach($order->orderProducts as $products)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" class="offer_price" name="offer_price[]" value="{{ $products->offer_price }}"/>
                                            </td>
                                          <td>
  ...
  $( "#search2" ).autocomplete({
    ...
    function calculateSum() {
        ...
        tblrows.each(function (index) {
            ...
            let offer_price=tblrow.find('td input.offer_price').val();
           
            if(offer_price!=''){
                var amount=offer_price;
            } else {
                var amount=tblrow.find('td input.unit_price').val();
            }
