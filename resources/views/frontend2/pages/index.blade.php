                            ...
                            <div class="slider-banner">
                                <div class="slider-img">
                                    <ul class="layout2-slide-1">
                                        <li id="img-1"><img src="{{ asset('assets') }}/images/layout-1/slider/1.1.png"
        ...
        <div class="product-item" style="">
            <div class="product_thumb bg-white prd_img" style="">
                {{-- @if (!empty($sale->product->id))
                    <a class="primary_img " href="{{ route('front.product.show', [$sale->product->id]) }}"><img
                            src="{{ asset('uploads/custom-images2/' . $sale->product->thumb_image) }}" class="primcusImg"
                            alt=""></a>
                    <a class="secondary_img " href="{{ route('front.product.show', [$sale->product->id]) }}"><img
                            src="{{ asset('uploads/custom-images2/' . $sale->product->thumb_image) }}" class="seccusImg"
                            alt=""></a>
                @endif --}}
{{--
            ...
            <div class="product_content" style="border-top:3px solid #EDEDEF; margin-top: 10%;">
                <h4 class="ps-1" style="height: 40px;text-align: center;">
                    @if (!empty($sale->product->id))
                        <a href="{{ route('front.product.show', [$sale->product->id]) }}" class="font-14"
                ...
                <div class="rounded-0 bg-muted p-2 d-flex justify-content-between">
                    ...
                    @else
                        <a href="{{ route('front.check.single', ['product_id' => $sale->product->id]) }}"
                            style="color: white; font-size: 16px;background: linear-gradient(90deg, #002f6c, #00c8ff) !important; border: solid;width: 100%;padding-top: 4%;"
                            class="btn btn-sm btn-warning semi buy-now" data-price="{{ $sale->product->price }}"
                                    ...
                                    <div class="product-detail">
                                        <div class="detail-title">
                                            <div class="detail-left">
                                                ...
                                                @if (!empty($sale->product->id))
                                                <a href="{{ route('front.product.show', [$sale->product->id]) }}">
                                                    <h6 class="price-title">{{ \Illuminate\Support\Str::limit($sale->product->name, 30) }}</h6>
                                                </a>
                                                @endif
                                            </div>
